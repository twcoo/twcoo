  ...
  <n-flex justify="center" class="pt-16">
    <n-card :bordered="false" class="max-w-2xl" :style="{ backgroundColor: 'transparent', boxShadow: 'none' }">
      ...
      <n-text class="text-lg block mt-2">
        I also maintain
        <strong>
          <a href="https://docs.threewhitecatsoneorange.dev" target="_blank" rel="noopener noreferrer"
            class="hover:underline">docs.threewhitecatsoneorange.dev</a> </strong>, where I share notes, interests, and
        topics I’m
        currently exploring.
      </n-text>
    </n-card>
